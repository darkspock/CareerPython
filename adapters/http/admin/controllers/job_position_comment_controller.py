...
from src.job_position.application.commands.mark_comment_as_reviewed_command import \
...
class JobPositionCommentController:
    ...
    def list_all_comments(
        ...
        """
        from src.job_position.application.queries.list_all_job_position_comments_query import \
