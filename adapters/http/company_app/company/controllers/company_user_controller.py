...
from adapters.http.company_app.company.mappers.company_user_mapper import CompanyUserResponseMapper
...
class CompanyUserController:
    ...
    def invite_company_user(
        ...
        from adapters.http.company_app.company.mappers.company_user_invitation_mapper import (
