...
from adapters.http.company_app.candidate_review.mappers.review_mapper import ReviewResponseMapper
...
from src.company_bc.candidate_review.application.commands.create_candidate_review_command import \
    CreateCandidateReviewCommand
from src.company_bc.candidate_review.application.commands.delete_candidate_review_command import \
    DeleteCandidateReviewCommand
from src.company_bc.candidate_review.application.commands.mark_review_as_pending_command import \
    MarkReviewAsPendingCommand
from src.company_bc.candidate_review.application.commands.mark_review_as_reviewed_command import \
    MarkReviewAsReviewedCommand
from src.company_bc.candidate_review.application.commands.update_candidate_review_command import \
...
from src.company_bc.candidate_review.application.queries.list_reviews_by_company_candidate_query import \
...
class ReviewController:
    ...
    def create_review(self, company_candidate_id: str, request: CreateReviewRequest,
                      created_by_user_id: str) -> ReviewResponse:
