...
from src.company_bc.company_candidate.domain.read_models.company_candidate_with_candidate_read_model import CompanyCandidateWithCandidateReadModel
...
class GetCompanyCandidateByIdWithCandidateInfoQueryHandler(QueryHandler[GetCompanyCandidateByIdWithCandidateInfoQuery, Optional[CompanyCandidateWithCandidateReadModel]]):
    ...
    def handle(self, query: GetCompanyCandidateByIdWithCandidateInfoQuery) -> Optional[CompanyCandidateWithCandidateReadModel]:
