...
class InterviewModel(Base):
    ...
    link_token: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)  # Unique token for secure interview link access
    link_expires_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)  # Expiration date for the interview link
