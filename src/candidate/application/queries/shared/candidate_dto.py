...
from src.candidate.domain.enums import CandidateStatusEnum, LanguageEnum, LanguageLevelEnum, CandidateTypeEnum, \
    WorkModalityEnum
from src.candidate.domain.enums.candidate_enums import PositionRoleEnum
