...
from src.candidate.application.queries.shared.candidate_education_mapper import CandidateEducationMapper
from src.candidate.domain.value_objects.candidate_id import CandidateId
from src.candidate.infrastructure.repositories.candidate_education_repository import \
