...
from src.company_page.application.commands.archive_company_page_command import ArchiveCompanyPageCommand
...
from src.company_page.application.commands.publish_company_page_command import PublishCompanyPageCommand
from src.company_page.application.commands.set_default_page_command import SetDefaultPageCommand
from src.company_page.application.commands.update_company_page_command import UpdateCompanyPageCommand
...
from src.company_page.application.queries.get_public_company_page_query import GetPublicCompanyPageQuery
from src.company_page.application.queries.list_company_pages_query import ListCompanyPagesQuery
from src.company_page.presentation.schemas.company_page_request import CreateCompanyPageRequest, \
...
class CompanyPageController:
    ...
    def list_pages(self, company_id: str, page_type: Optional[str] = None,
                   status: Optional[str] = None) -> CompanyPageListResponse:
