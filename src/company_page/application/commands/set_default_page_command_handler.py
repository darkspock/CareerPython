...
from src.company_page.domain.exceptions.company_page_exceptions import PageNotFoundException
...
class SetDefaultPageCommandHandler(CommandHandler[SetDefaultPageCommand]):
    ...
    def _unset_other_default_pages(self, company_id, page_type) -> None:
        """Desmarcar otras páginas del mismo tipo como default"""
