...
from adapters.http.candidate.controllers.file_attachment_controller import FileAttachmentController
from src.candidate_bc.candidate.presentation.schemas.file_attachment_response import FileAttachmentResponse
