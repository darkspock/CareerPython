...
from src.candidate_bc.candidate.application import \
    ListCandidateEducationsByCandidateIdQuery
from src.candidate_bc.candidate.application.queries.list_candidate_experiences_by_candidate_id import \
    ListCandidateExperiencesByCandidateIdQuery
from src.candidate_bc.candidate.application.queries.list_candidate_projects_by_candidate_id import \
    ListCandidateProjectsByCandidateIdQuery
from src.candidate_bc.candidate.application.queries.shared.candidate_experience_dto import CandidateExperienceDto
...
from src.candidate_bc.resume.application.services.resume_generation_service import ResumeGenerationService
