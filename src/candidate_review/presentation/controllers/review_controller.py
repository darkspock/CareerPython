...
from src.candidate_review.application.commands.create_candidate_review_command import CreateCandidateReviewCommand
from src.candidate_review.application.commands.update_candidate_review_command import UpdateCandidateReviewCommand
from src.candidate_review.application.commands.delete_candidate_review_command import DeleteCandidateReviewCommand
from src.candidate_review.application.commands.mark_review_as_reviewed_command import MarkReviewAsReviewedCommand
from src.candidate_review.application.commands.mark_review_as_pending_command import MarkReviewAsPendingCommand
from src.candidate_review.application.queries.get_review_by_id_query import GetReviewByIdQuery
from src.candidate_review.application.queries.list_reviews_by_company_candidate_query import ListReviewsByCompanyCandidateQuery
from src.candidate_review.application.queries.list_reviews_by_stage_query import ListReviewsByStageQuery
from src.candidate_review.application.queries.list_global_reviews_query import ListGlobalReviewsQuery
...
from src.candidate_review.presentation.mappers.review_mapper import ReviewResponseMapper
...
class ReviewController:
    ...
    def create_review(self, company_candidate_id: str, request: CreateReviewRequest, created_by_user_id: str) -> ReviewResponse:
        ...
        # Get the created review - we need to query by company_candidate_id and get the latest
