...
from src.job_position.domain.infrastructure.job_position_stage_repository_interface import JobPositionStageRepositoryInterface
from src.job_position.infrastructure.models.job_position_stage_model import JobPositionStageModel
