...
@dataclass
class DeactivateCompanyCommand(Command):
    company_id: str
    deactivated_by: str


class DeactivateCompanyCommandHandler(CommandHandler[DeactivateCompanyCommand]):
    def __init__(self, company_repository: CompanyRepositoryInterface):
        self.company_repository = company_repository

    def execute(self, command: DeactivateCompanyCommand) -> None:
