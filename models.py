...
from src.company_bc.job_position.infrastructure.models import JobPositionActivityModel
...
from src.auth_bc.user.infrastructure.models import UserAssetModel
...
from src.candidate_bc.resume import ResumeModel
