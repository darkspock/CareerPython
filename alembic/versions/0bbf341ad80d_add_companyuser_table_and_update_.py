"""Add CompanyUser table and update Company table with new structure

Revision ID: 0bbf341ad80d
Revises: 380733ccdc4d
Create Date: 2025-10-21 22:40:09.923157
...
revision: str = '0bbf341ad80d'
down_revision: Union[str, Sequence[str], None] = '380733ccdc4d'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['application_id'], ['candidate_applications.id'], name=op.f('fk_interviews_application_id_candidate_applications')),
    sa.ForeignKeyConstraint(['candidate_id'], ['candidates.id'], name=op.f('interviews_candidate_id_fkey')),
