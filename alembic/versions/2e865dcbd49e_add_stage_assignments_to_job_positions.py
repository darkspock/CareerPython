"""add stage_assignments to job_positions

Revision ID: 2e865dcbd49e
Revises: e6e09165ad42
Create Date: 2025-11-06 00:49:33.241093
...
revision: str = '2e865dcbd49e'
down_revision: Union[str, Sequence[str], None] = 'e6e09165ad42'
...
def upgrade() -> None:
    ...
    op.alter_column('job_position_activities', 'activity_type',
               existing_type=sa.VARCHAR(length=30),
               type_=sa.Enum('CREATED', 'EDITED', 'STAGE_MOVED', 'STATUS_CHANGED', 'COMMENT_ADDED', name='activitytypeenum', native_enum=False, length=20),
               existing_nullable=False)
    op.add_column('job_positions', sa.Column('stage_assignments', sa.JSON(), nullable=True))
...
def downgrade() -> None:
    ...
    op.alter_column('job_positions', 'description',
               ...
               type_=sa.VARCHAR(),
               existing_nullable=True)
    op.drop_column('job_positions', 'stage_assignments')
    op.alter_column('job_position_activities', 'activity_type',
               existing_type=sa.Enum('CREATED', 'EDITED', 'STAGE_MOVED', 'STATUS_CHANGED', 'COMMENT_ADDED', name='activitytypeenum', native_enum=False, length=20),
