...
from presentation.candidate.schemas.candidate import CandidateCreate, CandidateUpdate, CandidateResponse, \
    CandidateListResponse
from presentation.candidate.schemas.candidate_education import CandidateEducationResponse, \
...
from presentation.candidate.schemas.candidate_job_applications import (
    CandidateJobApplicationSummary,
    JobApplicationListFilters
)
from presentation.candidate.schemas.candidate_project import CandidateProjectResponse, CandidateProjectCreateRequest
from presentation.shared.schemas.token import Token
from presentation.shared.schemas.user import UserResponse
from presentation.shared.services.authentication_service import get_current_user
