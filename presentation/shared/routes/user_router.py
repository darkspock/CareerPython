...
from presentation.shared.schemas.token import PasswordResetResponse, PasswordResetConfirm, UserExistsResponse, \
    PasswordResetRequest
from presentation.shared.schemas.user import UserAutoCreateResponse, UserAutoCreateRequest, UserCreate, UserResponse, \
